...
const routes = [
  ...
  },
  {
    ...
    name: 'AdminParentDetail',
    component: () => import('@/views/admin/AdminParentDetail.vue'),
    meta: { admin: true },
  },
  {
    path: '/admin/teachers',
  ...
  },
  {
    ...
    component: () => import('@/views/admin/AdminTeacherDetail.vue'),
    meta: { admin: true },
  },
  {
  ...
  },
  {
    ...
    name: 'AdminKidsArea',
    component: () => import('@/views/admin/AdminKidsArea.vue'),
    meta: { admin: true },
  },
  {
    path: '/admin/messages',
  ...
  },
  {
    ...
    component: () => import('@/views/admin/AdminSubscriptionDetail.vue'),
    meta: { admin: true },
  },
  {
    path: '/admin/invoices/:id',
    name: 'AdminInvoiceDetail',
    component: () => import('@/views/admin/AdminInvoiceDetail.vue'),
    meta: { admin: true },
  },
  {
    path: '/admin/attendance/:id',
    name: 'AdminAttendanceDetail',
    component: () => import('@/views/admin/AdminAttendanceDetail.vue'),
    meta: { admin: true },
  },
  {
    path: '/admin/content/:id',
    name: 'AdminContentDetail',
    component: () => import('@/views/admin/AdminContentDetail.vue'),
    meta: { admin: true },
  },
  {
    path: '/admin/kidsarea/booking/:id',
  ...
  },
  {
    ...
    component: () => import('@/views/admin/AdminMessageDetail.vue'),
    meta: { admin: true },
  },
  {
    path: '/admin/portal-users',
    name: 'AdminPortalUsers',
    component: () => import('@/views/admin/AdminPortalUsers.vue'),
    meta: { admin: true },
  },
  {
    path: '/admin/reports',
